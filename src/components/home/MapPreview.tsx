 ...
 *
 * Real boundaries at a glance, the four national totals, and a route into the
 * full map page. The landing page shows; the map page explains.
 */
export function MapPreview({ locale, t }: { locale: Locale; t: Dictionary }) {
  ...
  return (
    <section className={`section on-ink ${styles.section} chev-edge-top`} aria-labelledby="map-title">
      <div className="shell">
        <SectionHead
          id="map-title"
